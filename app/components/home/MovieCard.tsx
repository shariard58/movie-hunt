...
const MovieCard = () => {
  return (
    <figure className="shadow-lg p-2 border border-black/10  dark:border-white/10 rounded-xl max-w-[240px] w-full h-[320px] sm:max-w-[260px] sm:h-[340px] md:max-w-[280px] md:h-[360px] lg:max-w-[300px] lg:h-[380px] xl:max-w-[320px] xl:h-[400px]">
      <div
